...
urlpatterns = (
    ...
    url(r'^judge/$', JudgementView.as_view(), name='article_judge'),
    ...
    url(r'^list/judge/$', cache_page(1)(MineJudgementListView.as_view()), name='article_judge_list'),
    ...
    url(r'^bigv/list/(?P<v_id>[\w-]+)/$', cache_page(1)(ArticleListForBigvView.as_view()), name='article_bigv_list'),
