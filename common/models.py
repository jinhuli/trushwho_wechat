...
# 
# class ArticlesBigVsDBV(models.Model):
...
#     bigv_name = models.CharField(_(u'名称'), max_length=32, blank=True, null=True)
#     bigv_pinyin = models.CharField(_(u'拼音'), max_length=256, blank=True, null=True)
#     bigv_brief = models.TextField(_(u'简介'), blank=True, null=True)
#     bigv_words_weight = models.IntegerField(_(u'言值'), blank=True, null=True)
#  
#     class Meta:
#         managed = False
...
#
#
# class BigVsDBV(models.Model):
#     v_id = models.CharField(_(u'id'), max_length=36)
